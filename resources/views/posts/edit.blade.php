                ...
                <div class="card-body">
                    <form  method="POST" action="{{ route('posts.update' , $post->id) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="content" id="content" rows="5" class="form-control {{ $errors->has('content') ? 'is-invalid' : '' }}">{{ $post->content }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="imagePreview">
                                <img style="width:300px;height:260px;margin-top:5px;object-fit:cover" class="image-preview img-thumbnail" src="{{ asset($post->image) }}" alt="">
                            </div>
                        </div>
